create or replace procedure kpi_metricas_empleados_mensuales_plex_v2(p_fecha date DEFAULT (CURRENT_DATE - '1 day'::interval))
    language plpgsql
as
$$
DECLARE
    ...
    IF v_count = 0 THEN
        ...
        WHERE kpi.anio_mes = v_month
          ...
          and ae.job_id in ('f229ae0c-e72b-4d94-9f03-c41388e3b7b0',
                            ...
                            'b0b64567-816b-465b-ad20-53a996a4966b',
        ...
        LOOP
            ...
            IF data.kpi_name = 'PEXTERNO 24 HORAS' THEN
                ...
                (kpi_mes, employee_id, employee_full_name,
                 ...
                 cumplimiento, resultado, resultado_2, region, puesto, id_kpi)
            ...
            ELSEIF data.kpi_name = 'CHURN POR PLEX' THEN
                ...
                INSERT INTO tbl_kpi_plex_cumplimiento_empleado_v2
                (kpi_mes, employee_id, employee_full_name, employee_kpi_name, kpi_description, start_date, weight,
                 target, unit_type, target_amount, ejecutado, cumplimiento, resultado, resultado_2, region, puesto, id_kpi)
                select a.ejecutado_mes,
                       employee_id,
                       employee_full_name,
                       employee_kpi_name,
